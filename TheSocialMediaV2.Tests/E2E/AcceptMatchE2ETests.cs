...
namespace TheSocialMediaV2.Tests.E2E
{
    public class AcceptMatchE2ETests : IClassFixture<ApiWebApplicationFactory>
    {
        ...
        public async Task POST_AcceptMatch_Should_Return200_AndUpdateDB_AndCreateOutboxEvent()
        {
            ...
            var db = scope.ServiceProvider.GetRequiredService<TheSocialMediaV2.API.Data.AppDbContext>();
            ...
            var verifyDb = verifyScope.ServiceProvider.GetRequiredService<TheSocialMediaV2.API.Data.AppDbContext>();
